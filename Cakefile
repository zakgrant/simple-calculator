...
task "test", "validate src against specs", (options)->
  exec "jasmine-node --coffee spec", endwith(->console.log "execute test suite!")

task "watch", "if there is a change in the folders [src, spec], execute specs", (options)->
